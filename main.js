...
//     let taskInputValue = input.value // INPUT VALUE
//     let tasksWrapper = document.querySelector('#tasksWrapper') // DIV
...
//     console.log(tasks, "1")
//     console.log(JSON.parse(localStorage.getItem('tasks')), "2")
//     e.target.reset();
...
//     content.innerHTML = `<input type="text" value="${taskInputValue}" readonly>`

//     let taskDelete = document.createElement('i')
//     taskDelete.classList.add('fa-solid', 'fa-trash-can', 'del')

//     let edit = document.createElement('i')
//     edit.classList.add('fa-solid', 'fa-pen-to-square', 'edit')

//     content.appendChild(taskDelete)
//     content.appendChild(edit)


//     tasksWrapper.appendChild(content)

//     input.value = ''

//     taskDelete.addEventListener('click', () => {
//         tasksWrapper.removeChild(content)
